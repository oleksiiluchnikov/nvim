...
M.vertical = function(picker)
  ...
  local layout = Layout({
    ...
    mount = function(self)
      ...
      self.prompt = open_win(true, prompt_width, 1, prompt_row, 0, 'Prompt')
      self.results = open_win(
        false,
        results_width,
        results_height,
...
M.flexible = function(picker)
  local function get_configs()
    ...
    if vim.o.columns > 120 then
      ...
      local results_height = (hide_preview and height or math.floor(height / 2))
        - 2
      res.results = {
        width = width,
