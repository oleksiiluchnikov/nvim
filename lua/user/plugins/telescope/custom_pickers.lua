...
local entry_makers = require('user.plugins.telescope.entry_makers')
...
local layouts = require('user.plugins.telescope.layouts')

---Choose a picker
---@usage :lua require('user.plugins.telescope.custom_pickers').choose_picker()
function M.choose_picker()
    require('telescope.builtin').builtin({
        cwd = vim.u.utils.get_root_dir(),
        hidden = false,
        follow = true,
        search_dirs = { vim.u.utils.get_root_dir() },
...
---@usage :lua require('user.plugins.telescope.custom_pickers').open_file()
...
---@usage :lua require('user.plugins.telescope.custom_pickers').open_file_from_home()
...
---@usage :lua require('user.plugins.telescope.custom_pickers').grep_across_workspace()
...
---@usage :lua require('user.plugins.telescope.custom_pickers').grep_cword_in_workspace()
---@see
...
---@usage :lua require('user.plugins.telescope.custom_pickers').grep_visual_selection_in_workspace()
---@see
function M.grep_visual_selection_in_workspace()
    local visual_selection = vim.u.utils.get_visual_selection()
    require('telescope.builtin').live_grep({
        cwd = vim.u.utils.get_root_dir(),
        hidden = false,
        follow = true,
...
---@usage :lua require('user.plugins.telescope.custom_pickers').grep_in_help_tags()
...
---@usage :lua require('user.plugins.telescope.custom_pickers').grep_cword_in_help_tags()
...
---@usage :lua require('user.plugins.telescope.custom_pickers').grep_visual_selection_in_help()
...
---@usage :lua require('user.plugins.telescope.custom_pickers').grep_in_current_buffer()
...
vim.keymap.set('n', '<leader>gr', function()
    M.fetch_repos()
end, { desc = 'List all git repositories in home' })

---Open a file path from typing
---@description Opens a file path from typing
---@usage :lua require('user.plugins.telescope.custom_pickers').open_path()
...
---@usage :lua require('user.plugins.telescope.custom_pickers').list_inlinks()
...
vim.api.nvim_create_user_command('GrepNotesWithoutTags', function()
    require('user.plugins.telescope.custom_pickers').grep_notes_without_tags()
end, {
    nargs = '*',
    complete = 'customlist,v:lua._telescope.builtin_commands',
})
...
vim.api.nvim_create_user_command('GrepNotes', function()
    require('user.plugins.telescope.custom_pickers').grep_notes()
end, {
    nargs = '*',
    complete = 'customlist,v:lua._telescope.builtin_commands',
})
...
vim.api.nvim_create_user_command('TelescopeBrowseFilesInProject', function()
    require('user.plugins.telescope.custom_pickers').browse_files_in_project()
end, {
    nargs = '*',
    complete = 'customlist,v:lua._telescope.builtin_commands',
})
...
vim.api.nvim_create_user_command('FetchListOfRepos', function()
    require('user.plugins.telescope.pickers').fetch_list_of_repos()
end, {})
