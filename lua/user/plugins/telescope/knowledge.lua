...
local public_note_mark = '^share: true$'
local search = ''
...
vim.keymap.set('n', '<leader>kpn', function() grep_public_notes() end,
    {
        silent = true,
        noremap = true,
...
vim.keymap.set('n', '<leader>knwl', function() grep_notes_without_wiki_links() end,
    {
        silent = true,
        noremap = true,
...
vim.keymap.set('n', '<leader>kp', function() grep_notes_with_tag('Project') end,
    {
        silent = true,
        noremap = true,
...
-- FIXME: This is not working as expected
local function grep_notes_with_tags_included_and_excluded(included_tags, excluded_tags)
    local regex = ''
...
grep_notes_with_tags_included_and_excluded(included_tags, excluded_tags)
